...
const featurescard = [
  {
    ...
    subtitle:
      "Take control of your posting schedule with ease. Plan weeks of content in minutes and let our automation handle the rest.",
  },
  {
    icon: <Pencil className="w-6 h-6 text-primary" />,
    title: "Content Optimization",
    subtitle:
      "Craft impactful posts with AI-driven recommendations. Optimize your tone, structure, and timing to captivate your audience.",
  },
  {
    icon: <ChartBar className="w-6 h-6 text-primary" />,
    title: "Analytics That Matter",
    subtitle:
      "Get actionable insights on your content performance. Understand what works, refine your strategy, and watch your engagement grow.",
  },
];
